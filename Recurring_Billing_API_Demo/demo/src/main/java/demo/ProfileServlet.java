...
public class ProfileServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		out.println("<h2>Welcome " + firstName + "! </h2><br>");
		...
		out.println("Last Name: <input type=\"text\" name=\"LastName\" value = "
				+ documents.get("CustomerData").get("LastName") + "><br><br>");
		out.println("Phone: <input type=\"text\" name=\"Phone\" value = " + documents.get("CustomerData").get("Phone")
				+ "><br><br>");
		out.println("Email: <input type=\"text\" name=\"Email\" value = " + documents.get("CustomerData").get("Email")
				+ "><br><br>");

		out.println("<h2>Credit Card Information</h2>");
		out.println("Account Number: <input type=\"text\" name=\"AccountNumber\"  value = "
				+ documents.get("CreditCardData").get("AccountNumber") + "><br><br>");
		out.println("Expiration Date: <input type=\"text\" name=\"ExpirationDate\"  value = "
				+ documents.get("CreditCardData").get("ExpirationDate") + "><br><br>");
		out.println("CVV: <input type=\"text\" name=\"CVV\" value = " + documents.get("CreditCardData").get("CVV")
				+ "><br><br>");

		out.println("<h2>Subscription Details</h2>");
		out.println("Amount: <input type=\"text\" name=\"Amount\"  value = "
				+ documents.get("SubscriptionData").get("Amount") + "><br><br>");
		out.println("Frequency: <input type=\"text\" name=\"Frequency\"  value = "
				+ documents.get("SubscriptionData").get("Frequency") + "><br><br>");
		out.println("Billing Date: <input type=\"text\" name=\"BillingDate\"  value = "
				+ documents.get("SubscriptionData").get("BillingDate") + "><br><br>");
		out.println("Failure Option: <input type=\"text\" name=\"FailureOption\"  value = "
				+ documents.get("SubscriptionData").get("FailureOption") + "><br><br>");
		out.println("Number of Payments: <input type=\"text\" name=\"NumberOfPayments\"  value = "
				+ documents.get("SubscriptionData").get("NumberOfPayments") + "><br><br>");
		out.println("Retries: <input type=\"text\" name=\"Retries\"  value = "
				+ documents.get("SubscriptionData").get("Retries") + "><br><br>");
		out.println("Description: <input type=\"text\" name=\"Description\"  value = "
				+ documents.get("SubscriptionData").get("Description").toString() + "><br><br>");
